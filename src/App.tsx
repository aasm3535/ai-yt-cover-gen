  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[#1e1e1e] flex font-sans text-zinc-50 antialiased selection:bg-zinc-700 selection:text-zinc-50">
      ...
      <main className="flex-1 relative overflow-auto custom-scrollbar canvas-bg z-10">
        <div className="min-h-full min-w-full p-6 lg:p-12 flex flex-col items-center">
                    ...
                    {isGeneratingThisEdit ? (
                      ...
                      <>
                        <img
                          ...
                          alt={item.topic}
                          onClick={() => setPreviewImage(currentVersion.url)}
                          className="w-full h-full object-cover transition-transform duration-700 ease-out group-hover/canvas:scale-[1.02] cursor-pointer"
                        />
      ...
      {previewImage && (
        ...
        >
          <div className="relative max-w-[90vw] max-h-[90vh] flex items-center justify-center animate-in fade-in zoom-in duration-200">
            <button
              onClick={() => setPreviewImage(null)}
              className="absolute -top-12 right-0 text-zinc-400 hover:text-white bg-black/50 hover:bg-black/80 rounded-full p-2 transition-all"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
