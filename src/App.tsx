...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen w-screen overflow-hidden bg-[#1e1e1e] flex font-sans text-zinc-50 antialiased selection:bg-zinc-700 selection:text-zinc-50">
      ...
      {/* Canvas Area */}
      <main className="flex-1 relative overflow-hidden bg-[#1e1e1e] z-10 cursor-grab active:cursor-grabbing">
        <TransformWrapper
          initialScale={1}
          minScale={0.1}
          maxScale={5}
        ...
        >
          ...
          >
            <div className="w-[6000px] h-[6000px] canvas-bg flex flex-col items-center justify-center p-12">
